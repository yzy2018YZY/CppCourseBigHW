...
const int PCOLOR_LINE_PINK = RGB(255, 155, 192);
const int PCOLOR_FILLED_PINK = RGB(245, 180, 217);

const int PCOLOR_HEAD_LINE = PCOLOR_LINE_PINK;
const int PCOLOR_HEAD_FILLED = PCOLOR_FILLED_PINK;

const int PCOLOR_NOSE_LINE = PCOLOR_LINE_PINK;
const int PCOLOR_NOSE_FILLED = PCOLOR_FILLED_PINK;
const int PCOLOR_NOSTRIL = RGB(160, 82, 45);

const int PCOLOR_BODY_LINE = RGB(255, 110, 90);
const int PCOLOR_BODY_FILLED = RGB(235, 90, 71);

const int PCOLOR_EARS_LINE = PCOLOR_LINE_PINK;
const int PCOLOR_EARS_FILLED = PCOLOR_FILLED_PINK;

const int PCOLOR_HANDS = PCOLOR_LINE_PINK;

const int PCOLOR_CHEEK = PCOLOR_LINE_PINK;
const int PCOLOR_EYE = PCOLOR_LINE_PINK;
const int PCOLOR_EYEBALL = RGB(255, 255, 255);
const int PCOLOR_PUPILS = RGB(0, 0, 0);

const int PCOLOR_MOUTH = RGB(239, 69, 19);
const int PCOLOR_FOOT = RGB(240, 128, 128);
const int PCOLOR_SHOES = RGB(0, 0, 0);

const int PCOLOR_TAIL = PCOLOR_LINE_PINK;
