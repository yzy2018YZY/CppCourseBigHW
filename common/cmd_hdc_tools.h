...
void hdc_init(const int bgcolor = COLOR_BLACK, const int fgcolor = COLOR_WHITE, const int width = 8 * 120, const int high = 16 * 30, const int fontSize = 16, const char font[] = "点阵字体");
...
//新增
void hdc_draw_Mathematical_curve(const int point_x, const int point_y, const int startAngle, const int endAngle, const double a, const double b, const int thickness = 2, const int RGB_value = INVALID_RGB);
